...
#ifndef _NORTH_LIST_API_
#define _NORTH_LIST_API_
...
*@param toBeAdded a pointer to data that is to be added to the linked list
**/
// void insertNorthBack(NorthList *northlist, void *toBeAdded);
 ...
 **/
int deleteNorthDataFromList(NorthList *northlist, void *toBeDeleted);
