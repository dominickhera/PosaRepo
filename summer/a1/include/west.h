...
**/
void deleteWestList(WestList *list);
 ...
 **/
int deleteDataFromWestList(WestList *list, void *toBeDeleted);
 ...
 **/
void *getFromWestFront(WestList *list);
 ...
 **/
void *getFromWestBack(WestList *list);
