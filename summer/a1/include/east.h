...
#ifndef _EAST_LIST_API_
#define _EAST_LIST_API_
...
*@param toBeAdded a pointer to data that is to be added to the linked list
**/
// void insertEastBack(EastList *eastlist, void *toBeAdded);
...
*@param toBeAdded a pointer to data that is to be added to the linked list
**/
void insertEastSorted(EastList *list, void *toBeAdded);
 ...
 **/
int deleteDataFromEastList(EastList *list, void *toBeDeleted);
