...
# filemenu.add_command(label="Save", command=sosPlsWork, accelerator="Ctrl+S")
# root.bind("<Control-s>", root.sosPlsWork)
# filemenu.add_command(label="Save as...", command=donothing)
menubar.add_cascade(label="File", menu=filemenu)
filemenu.add_command(label="Exit", command=quit, accelerator="Ctrl+X")
# root.config(menu=menubar)
frame.bind("<Control-x>", quit)
filemenu.add_command(label="Save", command=donothing, accelerator="Ctrl+S")
# root.config(menu=menubar)
frame.bind("<Control-S>", donothing)
...
# playerTurnString.set("Player 1's Turn")
root.config(menu=menubar)
# root.bind_all("<Control-x>", exit)
# root.bind("<Control-s>", sosPlsWork)
# root.bind_all("<Control-o>", donothing)
